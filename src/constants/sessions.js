...
export const GET_ALL_ENDED_SESSIONS_REQUEST = 'GET_ALL_ENDED_SESSIONS_REQUEST';
export const GET_ALL_ENDED_SESSIONS_SUCCESS = 'GET_ALL_ENDED_SESSIONS_SUCCESS';
export const GET_ALL_ENDED_SESSIONS_FAIL = 'GET_ALL_ENDED_SESSIONS_FAIL';
export const GET_ALL_ENDED_SESSIONS_RESET = 'GET_ALL_ENDED_SESSIONS_RESET';

export const GET_ALL_NOT_ENDED_SESSIONS_REQUEST =
    'GET_ALL_NOT_ENDED_SESSIONS_REQUEST';
export const GET_ALL_NOT_ENDED_SESSIONS_SUCCESS =
    'GET_ALL_NOT_ENDED_SESSIONS_SUCCESS';
export const GET_ALL_NOT_ENDED_SESSIONS_FAIL =
    'GET_ALL_NOT_ENDED_SESSIONS_FAIL';
export const GET_ALL_NOT_ENDED_SESSIONS_RESET =
...
export const END_SESSION_FAIL = 'END_SESSION_FAIL';
export const END_SESSION_RESET = 'END_SESSION_RESET';

export const ADD_SESSION_ORDERS_REQUEST = 'ADD_SESSION_ORDERS_REQUEST';
export const ADD_SESSION_ORDERS_SUCCESS = 'ADD_SESSION_ORDERS_SUCCESS';
export const ADD_SESSION_ORDERS_FAIL = 'ADD_SESSION_ORDERS_FAIL';
export const ADD_SESSION_ORDERS_RESET = 'ADD_SESSION_ORDERS_RESET';
