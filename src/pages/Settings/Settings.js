...
const Settings = ({ isNew }) => {
  const settings = JSON.parse(localStorage.getItem("settings"))?.data;
  const initialState = {
  ...
  return (
    <>
      <div className={styles.SettingsFormContainer}>
        ...
        >
          <Input
            label="PS4 Single hour price"
            name="ps4_single_hour"
            type="number"
          />
          <Input
            label="PS4 Multi hour price"
            name="ps4_multi_hour"
            type="number"
          />
          <Input label="PS4 Match price" name="ps4_match_hour" type="number" />
          <Input
            label="PS5 Single hour price"
            name="ps5_single_hour"
            type="number"
          />
          <Input
            label="PS5 Multi hour price"
            name="ps5_multi_hour"
            type="number"
          />
          <Input label="PS5 Match price" name="ps5_match_hour" type="number" />
        </Form>
      </div>
    </>
  );
